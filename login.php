...
<head>
  ...
  <link rel="stylesheet" href="remark/login.min.css">
  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
      <div class="brand">
        ...
        <h2 class="brand-text">Seu Clube do Ingresso</h2>
      </div>
      ...
      <form method="post" action="get_validar_acesso" id="login">
        ...
        <div class="form-group clearfix">
          <div class="checkbox-custom checkbox-inline checkbox-primary float-left">
            ...
            <label for="inputCheckbox">Me mantenha logado</label>
          </div>
          <a class="float-right" href="esqueci_senha">Esqueci minha senha.</a>
        </div>
        <?php
        if ($cadastro_naoconfirmado) {
          ...
          <div class="alert alert-danger">
            ...
            <center><span>
              </span><strong> Verificamos que você não havia confirmado sua conta!</strong></center>
            <center><strong>Enviamos um email para a confirmação, em caso de dúvida entre em contato com a gente!<br>
                <a href="email">Ajuda e contato.</a></strong></center>
          </div>
        <?php
      }
      ?>
        ...
        if ($erro == 1) {
          ...
          <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <center><span>
              </span><strong>Usuário e/ou senha inválidos.</strong></center>
          </div>
        <?php
      }
      ?>
      ...
      <p>Ainda não possui conta? Por favor, vá para <a href="cadastro">Cadastro</a></p>
